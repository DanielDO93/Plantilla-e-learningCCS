        ...
        <table className="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="align-middle">
                (0) Agente no sondea el nombre del cliente y/o no personaliza la
                llamada con el nombre o apellido de la misma.
              </td>
              <td className="align-middle">
            ...
            <tr>
              ...
              <td className="align-middle">
                (0) Agente no sondea lugar de entrega / da por hecho que será la
                misma dirección que esta previamente registrada.
              </td>
              <td className="align-middle">
                (0) Agente sondea lugar de entrega / verifica si la misma
                dirección que esta previamente registrada será donde llegara el
                pedido.
              </td>
              <td className="align-middle">
            ...
            <tr>
              ...
              <td className="align-middle">
                ...
                fit talla 36 con un costo de promocion de $999,00 pesos el cual
                se enviara al domiciolio confirmado.
              </td>
            </tr>
            <tr>
              <th colspan="5" scope="col" className="bg-danger text-white">
            ...
            <tr>
              ...
              <td className="align-middle">
                Revisar la escritura con corrector para contar buen aortografia
                al transmitir el mensaje en la intereaccion.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="align-middle">
                ...
                *No se si tengan todas las tallas y modelos que requiero. Las
                ...
                existencia por ello en este momento te confirmo la compra . *Lo
                voy a pensar . Aprovecha en este momento y se el primero en
            ...
            <tr>
              ...
              <td className="align-middle">
                (9) Agente menciona promociones del catalogo y de venta vía call
                center
              </td>
              <td className="align-middle">
            ...
            <tr>
              ...
              <td className="align-middle">
                Agente brinda frases de cortesía, no interrumpe al cliente y es
              ...
              <td className="align-middle">
                ( 2 ) Agente brinda frases de cortesía, no interrumpe al cliente
                cuando habla y es cortante.
              </td>
              <td className="align-middle">
            ...
            <tr>
              ...
              <td className="align-middle">
                *Jose: Hola (14:15) *Agente : ¡Hola! bienvenido a Men´s Fashion
                On Line, te atiende ______ (nombre del agente) (14:16)
              </td>
            </tr>
            <tr>
              <th colspan="5" scope="col" className="bg-danger text-white">
        ...
        <tbody>
          <tr>
            ...
            <td className="text-justify">
              ...
              de su revista_____.
              <br />
              Si menciona que no es la revista a la que es suscrito sondear cual
              es.
              <br />
              Esta revista cuenta con un precio en su puesto de revistas de $49
              cada una y anualmente cuenta con un precio de $588, en este
              momento para usted tenemos un precio especial de _____ que genera
              un ahorro considerable para su bolsillo. (validar en tabulador).
              <br />
              Sr/ Srita, le confirmo su número de suscriptor que aparece como
              (validar costumer), la revista estará llegando al nombre de
              (validar nombre).
              <br />
              La forma de pago es muy sencilla, solo es necesario que me brinde
              los 16 dígitos de su TDC o TDD, si cuenta con una departamental
              también es posible realizar el cargo. <br />
              ...
              <br />
              No tengo dinero <br />
              Comprendo, sin embargo, no requerimos el pago en efectivo en este
              momento, afortunadamente para usted contamos con el pago a TDC o
              departamental.
              <br />
              ...
              (Mujer) Cosmopolitan o Vanidades, (Hombre) Automóvil Panamericano
              y Mens Healt
              <br />
              Aplicar cierre. <br />
              ...
              <br />
              Como beneficio adicional en este momento le otorgamos un descuento
              preferencial en otra suscripción o en uno de nuestros libros de
              venta exclusiva. <br />
                Ø   CONFIRMACIÓN DE TODOS <br />
              Se deben confirmar al 100% todos los datos del cliente
              actualizando número telefónico y correo electrónico principalmente
              este ultimo
              <br />
                Ø   RECAPITULACION
              <br />
              ...
              <br />
              Agradecemos su tiempo quedamos a sus órdenes en el 01 800 7384782
              (REVISTA) le atendió ______________ de Editorial Televisa.
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <table className="table table-bordered table-responsive ">
          <tbody>
            ...
            <tr>
              ...
              <td width="382">
                Agente debe presentarse mencionando frase de cortesía, nombre de
                la empresa a la que representa, primer nombre y primer apellido,
                solicitando nombre y apellido de cliente
              </td>
              <td width="285">
                Agente, no menciona frase de cortesía, no proporcionó nombre de
                la empresa a la que representa, no indica su nombre y/o
                apellido.
              </td>
              <td width="277">
                Agente, se presenta mencionando frase de cortesía, nombre de la
                empresa a la que representa e indica su nombre con primer
                apellido.{' '}
              </td>
            </tr>
            <tr>
              ...
              <td>
                Agente no personalizó durante la llamada con nombre o apellido.
              </td>
              <td>
            ...
            <tr>
              ...
              Agente, realiza proceso completo acorde al tipo de llamada, ademas
              de mencionar encuesta de satisfaccion.
            ...
            <tr>
              ...
              <td>
                Agente debe solicitar, justificar y agradecer tiempos de espera,
                evitando exceder el 1 min establecido.
              </td>
              <td>
              ...
              <td>
                Agente solicita, justifica y agradece tiempos de espera cada sin
            ...
            <tr>
              <td>CORTESÍA Y EMPATÍA</td>
              <td>
                Agente se muestra cortes utilizando frases de cortesia, evitando
                ser sarcástico y no interrumpe al usuario.
              </td>
              <td>
              ...
              <td>
                Agente es cortes utilizando frases de cortesía, no es sarcástico
                y no interrumpe al usuario.{' '}
              </td>
            </tr>
            <tr>
              <td>ESCUCHA Y COMPRENDE</td>
              <td>
                Agente debe estar atento a las dudas e información del usuario,
                evita solicitar información ya proporcionada brindando una
                respuesta correcta
              </td>
              <td>
            ...
            <tr>
              ...
              <td>Agente permite desvío de conversación durante la llamada.</td>
              <td>
                Agente mantiene el liderazgo durante la llamada, no permite que
                el usuario se salga de contexto.{' '}
              </td>
            ...
            <tr>
              ...
              <td>
                Agente utiliza un vocabulario apropiado, no tiene muletillas,
                sonidos guturales, pleonasmos o extranjerismos, no habla rápido
                y presenta un tono de voz lineal.
              </td>
            </tr>
            ...
            <tr>
              <td>USO DE RECURSOS</td>
              <td>
                Agente debe utilizar correctamente las herramientas de trabajo,
                (aplicaciones, mute, intranet y pagina web).
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                Agente no menciona frase de cortesía, nombre de la empresa a la
                que representa, su nombre con primer apellido. (Despedida)
              </td>
              <td>
                Agente menciona frase de cortesía, nombre de la empresa a la que
                representa, su nombre con primer apellido. (Despedida)
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="table table-bordered table-responsive ">
          <tbody>
            ...
            <tr>
              <th className="align-middle">SALUDO</th>
              <td className="align-middle">
                AG realiza llamada de salida, menciona frase de cortesía, nombre
                de la empresa a la que representa y su primer nombre
              </td>
              <td className="align-middle">
                AG no menciona su nombre y/o menciona su apellido, no identificó
                nombre de la institución a la cual representa y/o omite frase de
                cortesía
              </td>
              <td className="align-middle">
                ( 4)
            ...
            <tr>
              ...
              <td className="align-middle">
                AG responde de forma clara, concreta e inmediata; transmitiendo
                la información solicitada al Usuario.
              </td>
              <td className="align-middle">
                ( 0 )<br />
                AG no proporciona información clara e inmediata; no transmite la
            ...
            <tr>
              ...
              <td className="align-middle">
                AG debe sondear datos del cliente como información de la queja,
                seguimiento, personalización, facturación, etc., que tiene;
                número telefónico alternos y correo electrónico, para mandar o
            ...
            <tr>
              ...
              <td className="align-middle">
                AG debe identificar el tipo de nivel del comentario en la matriz
                de escalación y capturar los datos completos del cliente
              </td>
              <td className="align-middle">
                ( 0 )<br />
                AG no identifica en tipo de nivel de acuerdo al comentario y no
                capturas datos completos del cliente.
              </td>
              <td className="align-middle">
                ( 12 )<br />
                AG identifica y canaliza de acuerdo a la matriz de escalación y
            ...
            <tr>
              ...
              <td className="align-middle">
                AG deberá realizar llamada de salida con cliente para determinar
                una solución de acuerdo al nivel de escalación.
              </td>
              <td className="align-middle">
                ( 0 )<br />
            ...
            <tr>
              ...
              <td className="align-middle">
                ( 12 )<br />
                AG ingresa en sistema el motivo de comentario en el aplicativo.
              </td>
              <td className="align-middle">12</td>
            </tr>
            ...
            <tr>
              ...
              <td className="align-middle">
                ( 0 )<br />
                El AG no agradeció la espera del usuario al retomar la llamada,
                no retomó cada 40 segundos dejando al usuario en la línea.
              </td>
              <td className="align-middle">
                ( 3 )<br />
                El AG al retomar la llamada agradece el tiempo de espera, retoma
                cada 40 segundos para informar que se esta realizando.
              </td>
            ...
            <tr>
              ...
              <td className="align-middle">
                ( 0 )<br />
                AG no brinda frases de cortesía y no personaliza mínimo 3 veces
                durante la llamada
              </td>
              <td className="align-middle">
                ( 3 )<br />
                AG brinda frases de cortesía, es amable y personaliza durante la
                llamada
              </td>
              <td className="align-middle">3</td>
            </tr>
            <tr>
              ...
              <td className="align-middle">
                AG se muestra atento a la llamada y a las dudas y preguntas del
                Usuario, evita solicitar información ya proporcionada y no
            ...
            <tr>
              ...
              <td className="align-middle">
                AG debe mantener liderazgo durante la llamada, sin permitir que
                el contacto se salga de contexto
              </td>
              <td className="align-middle">
                ( 0 )<br />
            ...
            <tr>
              ...
              <td className="align-middle">
                AG debe modular su voz de acuerdo a la llamada utilizando ritmo
                y tono de voz adecuados. Utiliza un vocabulario apropiado sin
                muletillas, palabras altisonantes, con correcta dicción, sin
                utilizar tecnicismos, pleonasmos, anglicismos o extranjerismos
              </td>
              <td className="align-middle">
                ( 0 )<br />
              ...
              <td className="align-middle">
                ( 3 )<br />
                AG lleva la llamada con un tono de voz dinámico y sin vicios de
                respiración. Utiliza un vocabulario apropiado, sin muletillas
                con palabras adecuadas y con correcta dicción
              </td>
              <td className="align-middle">3</td>
            </tr>
            ...
            <tr>
              ...
              <td className="align-middle">
                {' '}
                ( 0 ) <br />
                AG no menciona su nombre, no menciona nombre de la institución a
                la cual representa y omite frase de cortesía
              </td>
              <td className="align-middle">
                ( 2 )<br />
      ...
      <table className="table table-bordered table-responsive">
        <tbody>
          ...
          <tr>
            <th className=""></th>
            <td className="text-justify">
              ¡Hola! Buen día, (tardes, noches) bienvenido a Condé Nast México,
              le atiende _____, ¿Con quién tengo el gusto?
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="text-justify">
              ...
              inconveniente generado, no se preocupe, vamos a verificar cuál fue
              el tema, para resolverlo lo antes posible, ¿me confirma por favor
              el nombre completo con el que generó la suscripción?, para ubicar
              el registro en sistema_____.{' '}
            </td>
          </tr>
          <tr>
            ...
            <td className="text-justify">
              ...
              reporte de investigación en Correos de México para verificar cuál
              está siendo el problema y solucionarlo lo antes posible, me
              confirma si es tan amable, el nombre completo con el que generó la
              suscripción?, para ubicar el registro en sistema_____.{' '}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="text-justify">
              ...
              innovador, GQ ofrece al público material de los mejores expertos,
              escritores y fotógrafos a nivel mundial convirtiéndose en ese
              aliado que uno necesita tener cerca.
            </td>
          </tr>
          <tr>
            <th className="align-middle ">REVISTA VOGUE</th>
            <td className="text-justify">
              Es la marca editorial más famosa de todos los tiempos. Fundada en
              1892, Vogue ha traspasado las fronteras mundiales para convertirse
              no sólo en ícono de la cultura pop sino también en la Biblia de la
              Moda de todas las regiones a las que pertenece.
              <br />
          ...
          <tr>
            ...
            <td className="text-justify">
              ...
              Digest), le estamos ofreciendo un excelente descuento del ___%, el
              costo sería de $____, por 12 ejemplares. ¿Le agregamos la
              suscripción?
            </td>
          </tr>
          <tr>
